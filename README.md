...
<div style="display: flex; flex-wrap: wrap; gap: 20px;">
    <div style="flex: 1;">
        <a href="https://skipy.top">
            <img src="https://res.cloudinary.com/draig/image/upload/v1718659648/Skipy/dd2xu82at8rf5on5gfym.png" alt="Skipy Icon" style="max-width: 30px;">
        </a>
        <br>
    ...
    <div style="flex: 1;">
        <a href="https://mailprex.top">
            <img src="https://res.cloudinary.com/draig/image/upload/v1718558756/mailprex/oygtrydqxplmyi6gp9iz.png" alt="Mailprex Icon" style="max-width: 30px;">
        </a>
        <br>
    ...
    <div style="flex: 1;">
        <a href="https://fuddy.click">
            <img src="https://res.cloudinary.com/draig/image/upload/v1694804873/fuddy/x3c0jyse51halioek934.png" alt="Fuddy Icon" style="max-width: 30px;">
        </a>
        <br>
